        ...
        if (!mobileMenu) {
            ...
            mobileMenu.innerHTML = `
                <nav class="flex flex-col space-y-4 p-4">
                    <a href="/" class="nav-link-mobile font-medium py-2 px-4">Home</a>
...
function highlightActivePage() {
    ...
    // Map paths to navigation elements
    const navLinks = {
        "home": document.getElementById("nav-home"),
        "": document.getElementById("nav-home"), // Also match empty path
    ...
    const mobileNavLinks = {
        ...
        "": document.getElementById("mobile-nav-home"), // Also match empty path
